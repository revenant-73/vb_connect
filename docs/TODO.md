...
- [ ] **Organizer Dashboard:** Tools for organizers to approve members and manage the group.
...
- [ ] **PWA Enhancement:** Finalize service worker and manifest for offline support and "Add to Home Screen" prompts.

## 📅 Future Features (v2)
- [ ] **Push Notifications:** Web Push for new events and urgent updates.
- [ ] **Multiple Groups:** Support for different neighborhoods or skill-specific sub-groups.
- [ ] **Map Integration:** Embedded Google Maps/Apple Maps for easier navigation.
...
- [ ] Enhance mobile responsiveness for the "Huddle" message input.
